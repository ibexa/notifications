...
namespace Ibexa\Bundle\Notifications\DependencyInjection;
...
final class IbexaNotificationsExtension extends Extension implements PrependExtensionInterface
{
    /**
